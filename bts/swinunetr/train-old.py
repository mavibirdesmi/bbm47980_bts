...
train_dataset = get_train_dataset("/home/vedatb/senior-project/data/btsed_dataset")
...
val_dataset = get_val_dataset("/home/vedatb/senior-project/data/btsed_dataset")
...
os.makedirs(
    "/home/vedatb/senior-project/bbm47980_bts/old-predictions-old/", exist_ok=True
)
...
with torch.no_grad():
    for idx, batch_data in enumerate(test_loader):
        ...
        headers = nrrd.read_header(batch_data["label_meta_dict"]["filename_or_obj"][0])

        nrrd.write(
            file=f"/home/vedatb/senior-project/bbm47980_bts/old-predictions-old/{batch_data['info']['patient_name'][0]}.nrrd",
            data=seg_out,
            header=headers,
        )
        print("*" * 80)
